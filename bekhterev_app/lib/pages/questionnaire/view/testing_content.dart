...
class TestContent extends StatefulWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => TestContent());
  }
...
class _TestContentState extends State<TestContent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Тест отношения к приему пищи'),
        centerTitle: false,
        ...
        Expanded(
          child: Stack(
            children: [
              InAppWebView(
                key: webViewKey,
                initialUrlRequest: URLRequest(url: Uri.parse("https://docs.google.com/forms/d/1d2HXpQIJ2Y_wTG0CinSQXXWKvUdPNrpRZT6kI-8-Y5Y/")),
