...
import 'package:bekhterev_app/pages/calendar/view/calendar_content.dart';
...
class CalendarPage extends StatefulWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => CalendarPage());
  }
...
class _CalendarPageState extends State<CalendarPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Календарь посещений'),
        centerTitle: false,
