...
class OldReceipt extends StatefulWidget {
  @override
  _OldReceiptState createState() => _OldReceiptState();
}

class _OldReceiptState extends State<OldReceipt> {
  @override
            ...
            children: <Widget>[
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      'Квитанция'.toUpperCase(),
                      style: TextStyle(
                          fontSize: 18.0, fontWeight: FontWeight.w700, color: Color(0xFF979797)),
                    ),
                    Container(
